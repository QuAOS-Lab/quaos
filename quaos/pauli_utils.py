...
def are_mutually_independent(pauli_string1: PauliString, pauli_string2: PauliString):
    return bool(np.all(pauli_string1.symplectic_product_matrix() @ pauli_string2.symplectic_product_matrix() == 0))
