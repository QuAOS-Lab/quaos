...
def _sector_label(inv: AtomicInvariant) -> Dict[str, Any]:
    return {
...
def _sector_certificate(inv: AtomicInvariant) -> Dict[str, Any] | None:
...
def build_sector_gap_report(invariants: List[AtomicInvariant]) -> Dict[str, Any]:
    """
...
def attach_cost_certificate(
    ...
    invariants: List[AtomicInvariant],
    *,
    completed: bool,
    p: int,
) -> None:
