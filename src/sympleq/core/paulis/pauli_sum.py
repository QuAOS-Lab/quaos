...
class PauliSum(PauliObject):
    ...
    def stabilizer_to_hilbert_space(self, check: bool = True) -> sp.csr_matrix:
        """
        ...
        ----------
        check : bool
            If True (default), run sanity checks on weights, commutativity, and qudit count.
            Set to False in performance-critical loops where the input is known to be valid.
        ...
        return sp.csr_matrix(np.outer(ground_state.conj(), ground_state))
