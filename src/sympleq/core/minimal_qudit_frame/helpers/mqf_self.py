...
from sympleq.core.symmetries.modular_helpers import mod_p, independent_columns, inv_mod_mat, omega_matrix
...
from .mqf_witt import witt_decompose_form
from .mqf_filtration import build_nilpotent_filtration
from .mqf_extension import (
    GFpExtension,
...
def mqf_blocks_in_self_sector_nonunipotent(
    F_sec: np.ndarray,
    T_sec: np.ndarray,
    Omega: np.ndarray,
    N: np.ndarray,
    ...
    """
    Certified MQF extraction for self-reciprocal, non-(x±1) sectors.
