"""
Theory-free brute-force oracle for the exact qudit cost.

This deliberately contains none of the MQF classification logic: it computes the
exact minimum of ``max_i k_i`` over invariant symplectic decompositions by
...
from sympleq.core.symmetries.modular_helpers import mod_p, rank_mod, nullspace_mod, omega_matrix, rref_mod
