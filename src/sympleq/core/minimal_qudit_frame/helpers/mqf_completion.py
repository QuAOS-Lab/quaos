...
from sympleq.core.symmetries.modular_helpers import inv_mod_mat, mod_p, omega_matrix
from .mqf_linear import split_uv, symplectic_completion_from_block
from .mqf_types import MQFBlock


def concat_blocks_to_partial_basis(blocks: List[MQFBlock], n2: int, p: int) -> np.ndarray:
    """
