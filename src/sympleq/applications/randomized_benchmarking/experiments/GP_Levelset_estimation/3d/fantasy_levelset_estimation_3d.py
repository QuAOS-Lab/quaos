...
def sobol_initial_candidates(
    ...
    Sobol gives points in [0, 1]^3, then we rescale to:
        [n_gates_min, n_gates_max] x [ratio_min, ratio_max] x [q_min, q_max]
    """
